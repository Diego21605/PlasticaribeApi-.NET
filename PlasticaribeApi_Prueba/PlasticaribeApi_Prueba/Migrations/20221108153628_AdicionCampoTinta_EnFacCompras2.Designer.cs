...
namespace PlasticaribeApi_Prueba.Migrations
{
    ...
    [Migration("20221108153628_AdicionCampoTinta_EnFacCompras2")]
    partial class AdicionCampoTinta_EnFacCompras2
    {
            ...
            modelBuilder.Entity("PlasticaribeApi_Prueba.Models.FacturaCompra_MateriaPrima", b =>
                {
                    ...
                    b.Property<long?>("Factura_CompraFacco_Id")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("Materia_PrimaMatPri_Id")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Factura_CompraFacco_Id");

                    b.HasIndex("MatPri_Id");

                    b.HasIndex("Materia_PrimaMatPri_Id");
            ...
            modelBuilder.Entity("PlasticaribeApi_Prueba.Models.FacturaCompra_MateriaPrima", b =>
                {
                    ...
                    b.HasOne("PlasticaribeApi_Prueba.Models.Factura_Compra", null)
                        .WithMany("FaccoMatPri")
                        .HasForeignKey("Factura_CompraFacco_Id");
                    ...
                    b.HasOne("PlasticaribeApi_Prueba.Models.Materia_Prima", null)
                        .WithMany("FaccoMatPri")
                        .HasForeignKey("Materia_PrimaMatPri_Id");
