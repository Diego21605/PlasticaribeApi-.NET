...
namespace PlasticaribeApi_Prueba.Data
{
    public class dataContext : DbContext
    {
        public dataContext(DbContextOptions<dataContext> options) : base(options) { }

        public DbSet<PlasticaribeApi_Prueba.Models.TipoIdentificacion> TipoIdentificaciones { get; set; }
        public DbSet<PlasticaribeApi_Prueba.Models.Empresa> Empresas { get; set; }
        ...
        public DbSet<PlasticaribeApi_Prueba.Models.Orden_Trabajo>? Orden_Trabajo { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Tratado>? Tratado { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Formato>? Formato { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Tipos_Impresion>? Tipos_Impresion { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Pistas>? Pistas { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Rodillos>? Rodillos { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Laminado_Capa>? Laminado_Capa { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Mezcla_Material>? Mezclas_Materiales { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Mezcla_Pigmento>? Mezclas_Pigmentos { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Mezcla> Mezclas { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.OT_Extrusion>? OT_Extrusion { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.OT_Impresion> OT_Impresion { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.OT_Laminado> OT_Laminado { get; set; }
      
        public DbSet<PlasticaribeApi_Prueba.Models.Estados_ProcesosOT> Estados_ProcesosOT { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Falla_Tecnica> Fallas_Tecnicas { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Tipo_FallaTecnica> Tipos_FallasTecnicas { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Entrada_Tintas> Entradas_Tintas { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Detalles_EntradaTintas> Detalles_EntradaTintas { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.EntradaRollo_Producto> EntradasRollos_Productos { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.DetalleEntradaRollo_Producto> DetallesEntradasRollos_Productos { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.AsignacionProducto_FacturaVenta> AsignacionesProductos_FacturasVentas { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.DetallesAsignacionProducto_FacturaVenta> DetallesAsignacionesProductos_FacturasVentas { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.Devolucion_ProductoFacturado> Devoluciones_ProductosFacturados { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.DetalleDevolucion_ProductoFacturado> DetallesDevoluciones_ProductosFacturados { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.TipoDevolucion_ProductoFacturado> TiposDevoluciones_ProductosFacturados { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.PreEntrega_RolloDespacho> PreEntrega_RollosDespacho { get; set; }

        public DbSet<PlasticaribeApi_Prueba.Models.DetallePreEntrega_RolloDespacho> DetallesPreEntrega_RollosDespacho { get; set; }
    }
